#ifndef SROTHMAN_EECS_V2_CA_RES3_CALCULATOR_H
#define SROTHMAN_EECS_V2_CA_RES3_CALCULATOR_H
...
namespace EEC{
...
#ifdef CMSSW_GIT_HASH
        CARes3Calculator(const edm::ParameterSet& iConfig);
    ...
    class CARes3TransferCalculator {
    public:
        CARes3TransferCalculator(
...
#ifdef CMSSW_GIT_HASH
        CARes3TransferCalculator(const edm::ParameterSet& iConfig);
        static void fillPSetDescription(edm::ParameterSetDescription& desc);
#endif
