...
static void call_res3(
    ...
    res3_mainloop<false, BasicContainer, PairsType, false, BasicContainer, false>(
            result,
            nullptr,
            nullptr, 
            nullptr,
...
static void call_res3_matched(
    ...
    res3_mainloop<false, BasicContainer, PairsType, true, BasicContainer, false>(
            result, 
            &unmatched,
            nullptr, 
            nullptr,
...
static void call_res3_transfer(
    ...
    res3_mainloop<false, BasicContainer, PairsType, true, TransferContainer, true>(
            result_gen,
            &unmatched_gen,
            &transfer,
            thisjet_reco,
