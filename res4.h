...
namespace fastEEC{
    ...
    bool checkTriangle(const float shapetol,
        ...
        T dR2_12 = simon::deltaR2(eta1, phi1, eta2, phi2);
        T dR2_13 = simon::deltaR2(eta1, phi1, eta3, phi3);
        T dR2_23 = simon::deltaR2(eta2, phi2, eta3, phi3);
        ...
        if (std::abs(RL2/RM2 - triangleLM2) > shapetol){
            ...
            T deta_A4 = eta4 - etaA;
            T dphi_A4 = simon::deltaPhi(phiA, phi4);
            ...
            T deta_AB = etaB-etaA;
            T dphi_AB = simon::deltaPhi(phiA, phiB);
             ...
             */
            T deta_AC = etaC-etaA;
            T dphi_AC = simon::deltaPhi(phiA, phiC);
    ...
    unsigned linesCross(const float shapetol,
        ...
        T dR2Centroid = simon::deltaR2(etaAB, phiAB, etaCD, phiCD);
        ...
        T dR2TeeA = simon::deltaR2(etaA, phiA, etaCD, phiCD);

        if (dR2TeeA < shapetol*shapetol){
            return 2;
        }

        const T dR2TeeB = simon::deltaR2(etaB, phiB, etaCD, phiCD);
    ...
    void getrandangle(const T etaA, const T etaB, const T etaC, const T etaD,
        ...
        T etaAB = etaB - etaA;
        T phiAB = simon::deltaPhi(phiA, phiB);

        T etaCD = etaD - etaC;
        T phiCD = simon::deltaPhi(phiC, phiD);
